...
$gctb --sbayes S  \
      --ldm ${PWD}/interval_shrunk_chr_all.ldm.sparse  \
    ...
    --no-mcmc-bin \
    --out-freq 10 \
    --out /rds/project/jmmh2/rds-jmmh2-projects/inouye_lab_other/impute_genomics/omics_prs/methods_benchmark/results/GCTB/${1}_1